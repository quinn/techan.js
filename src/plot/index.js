...
export const plot = function (d3) {
	...
	d3Functor = util().functor,
	plotMixin = _plotmixin(d3.scaleLinear, d3Functor, scale.financetime, plot.dataSelector, plot.barWidth),
	...
	return {
		...
		tradearrow:      tradearrow(d3.select, d3Functor, d3.mouse, d3.dispatch, accessor.trade, plot, plotMixin, svg.arrow),
